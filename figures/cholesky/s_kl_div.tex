\begin{tikzpicture}[baseline, scale=0.75]
  ...
  \addplot [very thick, lightblue]  table
    {figures/cholesky/s_kl_div_KL.csv};
  \addplot [very thick, seagreen]   table
    {figures/cholesky/s_kl_div_KL_agg.csv};
  \addplot [very thick, darksilver] table
    {figures/cholesky/s_kl_div_select-KNN.csv};
  \addplot [very thick, orange]     table
    {figures/cholesky/s_kl_div_select.csv};
  \addplot [very thick, rust]       table
    {figures/cholesky/s_kl_div_select_agg.csv};
  \end{semilogyaxis}
\end{tikzpicture}
