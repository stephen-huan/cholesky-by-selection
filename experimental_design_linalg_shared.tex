...
\headers{Experimental design for fast algorithms}{S. Huan and F. Sch{\"a}fer}

% Title. If the supplement option is on, then "Supplementary Material"
% is automatically inserted before the title.
\title{Experimental design for fast linear algebra}

% Authors: full names plus addresses.
\author{%
  Stephen\ Huan\thanks{Georgia Institute of Technology \newline \email{florian.schaefer@cc.gatech.edu}} and 
  Florian\ Sch{\"a}fer\thanks{Georgia Institute of Technology, S1317 CODA, 756 W Peachtree St Atlanta, GA 30332, \newline \email{florian.schaefer@cc.gatech.edu},\newline Corresponding Author} 
}
