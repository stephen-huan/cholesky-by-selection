...
= 65536 \) points from the unit hypercube in \( D = 3 \) dimensions with a
...
\begin{figure}[t]
  ...
  \caption{
    ...
    65536 \) points and a factor density of \( \rho = 4 \).
...
\begin{figure}[t]
  ...
  \caption{
    ...
    increasing preconditioner density \( \rho \) for \( N = 65536 \) points.
