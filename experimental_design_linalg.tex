...
However, these works often focus on the global approximation of the entire process,
...
This sum is the accumulated \emph{difference} in posterior variance for
