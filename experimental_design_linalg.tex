...
\begin{figure}[t]
  ...
  \includegraphics{figures/precompiled/sarcos.pdf}
  \caption{
...
\begin{figure}[t]
  \centering
  % \input{figures/oco2/oco2.tex}
  \includegraphics{figures/precompiled/oco2.pdf}
  \caption{
    The first 4,682 points of the OCO-2 training
    data, visualizing the first two features.
  }
  \label{fig:oco2}
\end{figure}
