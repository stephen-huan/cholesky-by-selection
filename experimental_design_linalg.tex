...
extend this result to adjacent and non-adjacent aggregated factorization
in \cref{subsec:kl}.
...
\begin{figure}[ht]
  ...
  \caption{KL divergence with increasing \( N \)}
\end{figure}

\begin{figure}[ht]
  \centering
  \input{figures/cholesky/n_time.tex}
  \caption{Time with increasing \( N \)}
\end{figure}

\begin{figure}[ht]
  \centering
  \input{figures/cholesky/rho_kl_div.tex}
  \caption{KL divergence with increasing \( \rho \)}
\end{figure}

\begin{figure}[ht]
  \centering
  \input{figures/cholesky/rho_time.tex}
  \caption{KL divergence against time with increasing \( \rho \)}
\end{figure}

\begin{figure}[ht]
  \centering
  \input{figures/cholesky/s_kl_div.tex}
  \caption{KL divergence with increasing \( \rho_s \)}
\end{figure}

\begin{figure}[ht]
  \centering
  \input{figures/cholesky/s_time.tex}
  \caption{Time with increasing \( \rho_s \)}
\end{figure}
...
\begin{figure}[ht]
  \centering
  \input{figures/gp/rho_logdet.tex}
  \caption{Log determinant with increasing \( \rho \)}
\end{figure}

\begin{figure}[ht]
  \centering
  \input{figures/gp/rho_time_logdet.tex}
  \caption{Log determinant against time with increasing \( \rho \)}
\end{figure}

\begin{figure}[ht]
  \centering
  \input{figures/gp/rho_loss.tex}
  \caption{RMSE loss with increasing \( \rho \)}
\end{figure}

\begin{figure}[ht]
  \centering
  \input{figures/gp/rho_time_loss.tex}
  \caption{RMSE against time with increasing \( \rho \)}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Residual with iterations}
\end{figure}

\begin{figure}[ht]
  \centering
  \input{figures/cg/nnz_nnz.tex}
  \caption{Nonzero entries per column with increasing \( N \)}
\end{figure}

\begin{figure}[ht]
  \centering
  \input{figures/cg/rho_iter.tex}
  \caption{Iterations with increasing \( \rho \)}
\end{figure}

\begin{figure}[ht]
  \centering
  \input{figures/cg/rho_time.tex}
  \caption{Time with increasing \( \rho \)}
\end{figure}
