...
\begin{align}
  \label{eq:obj_mult}
  \sum_{i \in \tilde{i}}
    \log \left (\CM_{i \mid s_i \setminus \{ i \} } \right ) &=
...
% TODO: this goes on for too long
...
one and rest zero).
This method is described in Algorithm 3.2 and
illustrated in Figure 4 of \cite{schafer2021sparse}.
...
the precision matrix) from \cref{eq:obj_gp_mult}.
