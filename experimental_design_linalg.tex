...
pattern \( S \defeq \{ (i, j) : i \in s_j, i \succeq j \} \) specified then
all is needed is a functional criterion \( \loss: \Reals^{N \times N} \to
\Reals \) to specify the optimization problem
\begin{align}
